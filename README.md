...
База знаний для путешествий — маршруты, достопримечательности, логистика. Все статьи на русском языке.

---

## Однодневные поездки из Лондона
...
| [Гластонбери и Уэллс](travel-knowledge-base/uk/гластонбери-уэллс.md) | ~2 ч (Castle Cary + авт.) | Тор, аббатство, легенды Авалона, первый готический собор Англии |

### Сводная таблица всех маршрутов

[20 лучших однодневных поездок из Лондона](travel-knowledge-base/uk/london-day-trips.md) — полная таблица с временем в пути и ценами на билеты.

---

## Пешеходные маршруты по Лондону

[Сводная таблица маршрутов по паркам Лондона](travel-knowledge-base/uk/london-walking-routes/index.md) — все маршруты с дистанциями, временем и сложностью.
...
- [Шаблон страницы города](templates/city.md) — структура статьи о городе
- [Принципы документации](structure.md) — правила и формат базы знаний
